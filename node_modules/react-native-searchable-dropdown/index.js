  ...
  searchedItems = searchedText => {
    ...
    if (!setSort || typeof setSort !== 'function') {
      setSort = (item, searchedText) => {
        const nameMatch = item.name && item.name.toLowerCase().indexOf(searchedText.toLowerCase()) > -1;
        const codeMatch = item.code && item.code.toLowerCase().indexOf(searchedText.toLowerCase()) > -1;
